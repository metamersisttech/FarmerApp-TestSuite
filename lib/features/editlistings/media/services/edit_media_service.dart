...
/// Service for edit listing media: load listing for pre-fill, upload, PATCH.
class EditMediaService {
  final BackendHelper _backendHelper;

  EditMediaService({BackendHelper? backendHelper})
      : _backendHelper = backendHelper ?? BackendHelper();

  /// Get listing by ID for pre-fill (existing images)
