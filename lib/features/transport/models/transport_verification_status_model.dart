/// Transport verification status model
///
/// Maps the response from GET /api/auth/transport/verification-status/
/// Handles all three states: never applied, pending, approved, rejected.
class TransportVerificationStatusModel {
  ...
  const TransportVerificationStatusModel({
  ...
  factory TransportVerificationStatusModel.fromJson(Map<String, dynamic> json) {
    return TransportVerificationStatusModel(
